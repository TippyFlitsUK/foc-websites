...
export function App() {
  ...
  return (
    <div>
      ...
      <footer className="w-full text-center pt-8 pb-12 mt-8 border-t border-border">
        <a className="inline-flex items-center gap-3 no-underline" href="https://filecoin.cloud" rel="noopener" target="_blank">
          <span className="text-sm text-muted-foreground">Hosted on</span>
          <img alt="Filecoin Onchain Cloud" className="h-12 w-auto block dark:hidden" loading="lazy" src="/foc-logo-dark.svg" />
          <img alt="Filecoin Onchain Cloud" className="h-12 w-auto hidden dark:block" loading="lazy" src="/foc-logo-light.svg" />
        </a>
      </footer>
