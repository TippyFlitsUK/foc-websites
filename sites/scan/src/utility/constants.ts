...
export const networkContractAddresses = {
  mainnet: {
    PDPVerifier:
      import.meta.env.PUBLIC_MAINNET_PDP_VERIFIER ||
      '0xBADd0B92C1c71d02E7d520f64c0876538fa2557F',
    SimplePDPService:
      import.meta.env.PUBLIC_MAINNET_PDP_SERVICE ||
      '0x805370387fA5Bd8053FD8f7B2da4055B9a4f8019',
  },
  calibration: {
    PDPVerifier:
      import.meta.env.PUBLIC_CALIBRATION_PDP_VERIFIER ||
      '0x85e366Cf9DD2c0aE37E963d9556F5f4718d6417C',
    SimplePDPService:
      import.meta.env.PUBLIC_CALIBRATION_PDP_SERVICE ||
