---
title: WaitForCreateDataSetRejectedError
next: true
prev: true
editUrl: false
...
Defined in: [packages/synapse-core/src/errors/pdp.ts:49](https://github.com/FilOzone/synapse-sdk/blob/3122f8d73d8ad2c239837ef6f561996a746d514e/packages/synapse-core/src/errors/pdp.ts#L49)
...
> **new WaitForCreateDataSetRejectedError**(`error`): `WaitForCreateDataSetRejectedError`

Defined in: [packages/synapse-core/src/errors/pdp.ts:53](https://github.com/FilOzone/synapse-sdk/blob/3122f8d73d8ad2c239837ef6f561996a746d514e/packages/synapse-core/src/errors/pdp.ts#L53)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `error` | \{ `createMessageHash`: `` `0x${string}` ``; `dataSetCreated`: `false`; `ok`: `false`; `service`: `string`; `txStatus`: `"rejected"`; \} |
| `error.createMessageHash` | `` `0x${string}` `` |
| `error.dataSetCreated` | `false` |
| `error.ok` | `false` |
| `error.service` | `string` |
...
> **name**: `"WaitForCreateDataSetRejectedError"` = `'WaitForCreateDataSetRejectedError'`

Defined in: [packages/synapse-core/src/errors/pdp.ts:50](https://github.com/FilOzone/synapse-sdk/blob/3122f8d73d8ad2c239837ef6f561996a746d514e/packages/synapse-core/src/errors/pdp.ts#L50)
...
Defined in: [packages/synapse-core/src/errors/pdp.ts:51](https://github.com/FilOzone/synapse-sdk/blob/3122f8d73d8ad2c239837ef6f561996a746d514e/packages/synapse-core/src/errors/pdp.ts#L51)

#### createMessageHash

> **createMessageHash**: `` `0x${string}` `` = `zHex`
