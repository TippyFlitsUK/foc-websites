---
title: getAllDataSetMetadataCall
next: true
prev: true
editUrl: false
...
> **getAllDataSetMetadataCall**(`options`): `object`

Defined in: [packages/synapse-core/src/warm-storage/get-all-data-set-metadata.ts:118](https://github.com/FilOzone/synapse-sdk/blob/3122f8d73d8ad2c239837ef6f561996a746d514e/packages/synapse-core/src/warm-storage/get-all-data-set-metadata.ts#L118)
...
Use [parseAllDataSetMetadata](/reference/filoz/synapse-core/warm-storage/functions/parsealldatasetmetadata/) to parse the output into a MetadataObject.

## Parameters

| Parameter | Type | Description |
| ------ | ------ | ------ |
| `options` | \{ `chain`: `Chain`; `contractAddress?`: `` `0x${string}` ``; `dataSetId`: `bigint`; \} | [getAllDataSetMetadataCall.OptionsType](/reference/filoz/synapse-core/warm-storage/namespaces/getalldatasetmetadatacall/type-aliases/optionstype/) |
...
| `options.dataSetId` | `bigint` | The ID of the data set to get metadata for. |

## Returns

`object`

The call to the getAllDataSetMetadata function [getAllDataSetMetadataCall.OutputType](/reference/filoz/synapse-core/warm-storage/namespaces/getalldatasetmetadatacall/type-aliases/outputtype/)
...
> **functionName**: `"getAllDataSetMetadata"` = `'getAllDataSetMetadata'`

## Throws

Errors [getAllDataSetMetadataCall.ErrorType](/reference/filoz/synapse-core/warm-storage/namespaces/getalldatasetmetadatacall/type-aliases/errortype/)
