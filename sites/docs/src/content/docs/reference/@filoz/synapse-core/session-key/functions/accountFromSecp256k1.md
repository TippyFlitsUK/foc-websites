...
> **accountFromSecp256k1**(`options`): `object`

Defined in: [packages/synapse-core/src/session-key/secp256k1.ts:228](https://github.com/FilOzone/synapse-sdk/blob/3122f8d73d8ad2c239837ef6f561996a746d514e/packages/synapse-core/src/session-key/secp256k1.ts#L228)
...
| ------ | ------ | ------ |
| `options` | [`AccountFromSecp256k1Options`](/reference/filoz/synapse-core/session-key/interfaces/accountfromsecp256k1options/) | [AccountFromSecp256k1Options](/reference/filoz/synapse-core/session-key/interfaces/accountfromsecp256k1options/) |

## Returns

`object`

Account [SessionKeyAccount](/reference/filoz/synapse-core/session-key/type-aliases/sessionkeyaccount/)
...
> **sign**: (`parameters`) => [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`` `0x${string}` ``\>
...
> **signAuthorization**: (`parameters`) => [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`SignAuthorizationReturnType`\>
...
[`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`SignAuthorizationReturnType`\>

### signMessage

> **signMessage**: (`__namedParameters`) => [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`` `0x${string}` ``\>
...
> **signTransaction**: \<`serializer`, `transaction`\>(`transaction`, `options?`) => [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)\<`` `0x${string}` ``\>
...
| `transaction` *extends* `OneOf`\<`TransactionSerializable`\> | [`Parameters`](https://www.typescriptlang.org/docs/handbook/utility-types.html#parameterstype)\<`serializer`\>\[`0`\] |
